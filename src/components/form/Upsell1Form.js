...
import Upsell1ProductsJson from '../../../../helpers/json/master.json';
...
const Upsell1Products = [
  { value: 9, label: '4x Boxes of Detox Patches' },
  { value: 10, label: '3x Boxes of Detox Patches' },
  { value: 11, label: '2x Boxes of Detox Patches' },
  { value: 12, label: '1x Boxe of Detox Patches' },
];

export default function Upsell1Form({ validateUpsell1Form }) {
  ...
  useEffect(() => {
    validateUpsell1Form.current = validateCurrentForm;
    autofillData();
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < Upsell1ProductsJson.upsells.length; i += 1) {
      if (Upsell1ProductsJson.upsells[i].url === urlVal) {
        const arr = Upsell1ProductsJson.upsells[i].products;
        setProductsArr(arr);
        ...
        <Grid container spacing={2}>
          ...
          <Grid item md={6}>
            <FormDropdown
              ...
              message="Required"
              options={Upsell1ProductsJson.urls}
              require
            />
          </Grid>
          <Grid item md={6}>
...
Upsell1Form.propTypes = {
  validateUpsell1Form: PropTypes.any,
};
